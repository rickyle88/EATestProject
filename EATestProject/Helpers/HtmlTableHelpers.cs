...
namespace EAAutoFrameWork.Helpers
{
    ...
    {
        //Simple algorithm
        //Get the table => Get all the column header (th) and create an index
        //Get all the rows (tr) and create an index
        //Loop through all the rows and its data (td)
        //Store all the value in the collection
